...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(props) {
    ...
    var showDropdown = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(false);
    var selectedItems = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)([]);
    var loading = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(false);
    var showCreateModal = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(false);
    var filteredOptions = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
      if (!props.field.options) return [];
      return props.field.options.filter(function (option) {
        return option.label.toLowerCase().includes(search.value.toLowerCase()) && !selectedItems.value.some(function (selected) {
          return selected.value === option.value;
        });
      });
    });
    var selectItem = function selectItem(option) {
      selectedItems.value.push(option);
      search.value = '';
      showDropdown.value = false;
    };
    var removeItem = function removeItem(option) {
      selectedItems.value = selectedItems.value.filter(function (item) {
    ...
    var handleResourceCreated = function handleResourceCreated(resource) {
      var newOption = {
        value: resource.id.toString(),
        label: resource.title || "ID: ".concat(resource.id)
      };
      props.field.options = [].concat(_toConsumableArray(props.field.options), [newOption]);
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onMounted)(function () {
      ...
      if (props.field.value) {
        selectedItems.value = props.field.value.map(function (value) {
          var option = props.field.options.find(function (opt) {
            return opt.value === value;
          });
          return option || {
            value: value,
            label: "ID: ".concat(value)
          };
        }).filter(Boolean);
      }
    });
    ...
    return {
      ...
      handleResourceCreated: handleResourceCreated
    };
  },
  methods: {
    fill: function fill(formData) {
      formData.append(this.field.attribute, JSON.stringify(this.selectedItems.map(function (item) {
        return item.value;
      })));
    }
  }
...
var _hoisted_1 = {
  "class": "relative hasManySearchable"
};
var _hoisted_2 = {
...
var _hoisted_4 = {
  "class": "flex flex-wrap p-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900"
};
var _hoisted_5 = {
...
var _hoisted_7 = {
  key: 1,
  "class": "absolute dropDownMenu z-50 w-full mt-1 rounded-lg shadow-lg bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Create Button "), $props.field.showCreateButton ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "button",
      ...
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.field.createButtonLabel), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_CreateRelationModal, {
        show: $setup.showCreateModal,
        "resource-name": $props.field.resourceName,
        onCreateCancelled: _cache[1] || (_cache[1] = function ($event) {
          return $setup.showCreateModal = false;
        }),
        onSetResource: $setup.handleResourceCreated
      }, null, 8 /* PROPS */, ["show", "resource-name", "onSetResource"])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Main input container "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.selectedItems, function (selected) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: selected.value,
          "class": "inline-flex items-center px-2 py-1 m-1 text-sm rounded bg-gray-100 dark:bg-gray-800"
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(selected.label), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
          onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
            return $setup.removeItem(selected);
          }, ["prevent"]),
        ...
        onFocus: _cache[3] || (_cache[3] = function ($event) {
          return $setup.showDropdown = true;
        }),
        placeholder: "Search...",
        "class": "flex-grow min-w-[150px] p-1 outline-none border-none bg-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
      }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.search]])]), $setup.showDropdown ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.filteredOptions, function (option) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: option.value,
          onClick: function onClick($event) {
            return $setup.selectItem(option);
          },
      ...
      }), 128 /* KEYED_FRAGMENT */)), !$setup.filteredOptions.length && !$setup.loading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_9, " No options available ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $setup.loading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_10, " Loading... ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])];
    }),
    _: 1 /* STABLE */
...
Nova.booting(function (app, store) {
  app.component('index-has-many-searchable', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-has-many-searchable', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-has-many-searchable', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _Users_maxgrasymenko_www_api_one5rp_nova_components_HasManySearchable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_maxgrasymenko_www_api_one5rp_nova_components_HasManySearchable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _Users_maxgrasymenko_www_api_one5rp_nova_components_HasManySearchable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkacme_has_many_searchable"] = self["webpackChunkacme_has_many_searchable"] || [];
